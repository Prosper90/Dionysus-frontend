...
export default function LandingPage() {
  ...
  const features = [
    {
      ...
      description: "Engage your community with stake raffles, jackpot pools, meme battles, and team competitions.",
      color: "text-blue-600",
      bgColor: "bg-blue-100",
    },
    {
      ...
      description: "Support for BSC, BASE, and Solana networks with real-time USD conversion.",
    ...
    },
    {
      ...
      description: "Premium subscription tiers with advanced group features and leaderboards.",
    ...
    },
    {
      ...
      description: "Comprehensive analytics and revenue tracking for group performance.",
    ...
    },
    {
      ...
      description: "Enterprise-grade security with automated transaction processing.",
      color: "text-red-600",
      bgColor: "bg-red-100",
    },
    {
  ...
  const games = [
    {
      name: "Stake Raffles",
      description: "Users can join raffles with customizable entry fees and prizes",
      icon: "🎰",
    },
    {
      name: "Jackpot Pool",
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="max-w-4xl mx-auto">
            <div className="inline-flex items-center bg-blue-100 rounded-full px-4 py-2 mb-8">
              ...
              <span className="text-blue-800 font-medium">Next-Gen Telegram Engagement</span>
            </div>
            ...
            <p className="text-xl text-gray-600 mb-10 leading-relaxed max-w-3xl mx-auto">
              The ultimate Telegram bot for community engagement with interactive games, 
              multi-chain payments, and comprehensive analytics. Boost participation and 
              generate revenue with premium gaming features.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Everything you need to create engaging experiences and monetize your Telegram groups
            </p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-br from-gray-50 to-blue-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Engage your community with our comprehensive collection of interactive games and competitions
            </p>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8 text-center">
            <div className="p-6">
              <div className="text-4xl font-bold text-blue-600 mb-2">Multi-Chain</div>
            ...
            <div className="p-6">
              <div className="text-4xl font-bold text-green-600 mb-2">Advanced</div>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-purple-600">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-blue-100 mb-10">
            Join thousands of communities already using Dionysus EngagementBot to boost engagement and generate revenue.
          </p>
